        ...
        for i in range(self.NPC_size):
            for j in range(self.time_size):
                ...
                if isMutli == 0:
                    ...
                    v4 = random.uniform(self.bounds[2][0], self.bounds[2][1])
                    v5 = random.uniform(self.bounds[2][0], self.bounds[2][1])
                    v6 = random.uniform(self.bounds[2][0], self.bounds[2][1])

                    v = {"decelerate": v1, "accalare": v2, "stop": 0, "lanechangspeed": v3,
                         "turn_left": v4, "turn_right": v5, "u_turn": v6}
